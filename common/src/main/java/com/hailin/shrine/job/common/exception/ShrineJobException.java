...
public class ShrineJobException extends Exception {
	...
	public ShrineJobException(String message) {
		this(SYSTEM_ERROR, message);
	}

	public ShrineJobException(int type, String message) {
		super();
		this.type = type;
		this.message = message;
	}

	public ShrineJobException(int type, String message, Throwable cause) {
		super(cause);
		this.type = type;
		this.message = message;
	}
