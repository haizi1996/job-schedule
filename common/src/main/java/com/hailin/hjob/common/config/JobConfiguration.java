...
public class JobConfiguration implements JobRootConfiguration {
    ...
    public static class Builder {
        ...
        public final JobConfiguration build() {
            return new JobConfiguration(jobConfig, monitorExecution, maxTimeDiffSeconds, monitorPort, jobShardingStrategyClass, reconcileIntervalMinutes, disabled, overwrite);
        }
    }
}
