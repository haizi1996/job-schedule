package com.hailin.shrine.job.sharding.node;

/**
 * 执行器节点的常量和通用方法
 * @author zhanghailin
 */
public class ShrineExecutorsNode {
    ...
    private static final String Shrine_EXECUTORS_NODE = "$ShrineExecutors";
    ...
    public static final String SHARDING_COUNT_PATH = "/" + Shrine_EXECUTORS_NODE + "/" + SHARDING + "/" + "count";
    public static final String LEADER_HOSTNODE_PATH = "/" + Shrine_EXECUTORS_NODE + "/" + LEADER + "/" + HOST;
    public static final String LEADERNODE_PATH = "/" + Shrine_EXECUTORS_NODE + "/" + LEADER;
    public static final String EXECUTORSNODE_PATH = "/" + Shrine_EXECUTORS_NODE + "/" + EXECUTORS;
    public static final String SHARDINGNODE_PATH = "/" + Shrine_EXECUTORS_NODE + "/" + SHARDING;
    public static final String LEADER_LATCHNODE_PATH = "/" + Shrine_EXECUTORS_NODE + "/" + LEADER + "/" + LATCH;
    public static final String SHARDING_CONTENTNODE_PATH = "/" + Shrine_EXECUTORS_NODE + "/" + SHARDING + "/" + CONTENT;
    public static final String EXECUTOR_IPNODE_PATH_REGEX =
            "/\\" + Shrine_EXECUTORS_NODE + "/" + EXECUTORS + "/" + "[^/]*"
                    + "/" + IP;
    public static final String EXECUTOR_NO_TRAFFIC_NODE_PATH_REGEX =
            "/\\" + Shrine_EXECUTORS_NODE + "/" + EXECUTORS + "/" + "[^/]*"
                    + "/" + NO_TRAFFIC;
    public static final String CONFIG_VERSION_PATH = "/" + Shrine_EXECUTORS_NODE + "/config/version";

    public static final String JOBSNODE_PATH = "/" + JOBS_NODE;
    public static final String ShrineEXECUTORS_PATH = "/" + Shrine_EXECUTORS_NODE;

    /**
     * 获取$ShrineExecutors结点完整路径
     */
    public static String getShrineExecutorsNodeName() {
        return Shrine_EXECUTORS_NODE;
    }

    /**
     * 获取$ShrineExecutors/executors结点完整路径
     */
    public static String getExecutorsNodePath() {
        return "/" + Shrine_EXECUTORS_NODE + "/" + EXECUTORS;
    }
    ...
    /**
     * 获取$ShrineExecutors/executors/xx结点完整路径
     */
    public static String getExecutorNodePath(String executor) {
        return "/" + Shrine_EXECUTORS_NODE + "/" + EXECUTORS + "/" + executor;
    }

    /**
     * 获取$ShrineExecutors/executors/xx/ip结点完整路径
     */
    public static String getExecutorIpNodePath(String executor) {
        return "/" + Shrine_EXECUTORS_NODE + "/" + EXECUTORS + "/" + executor + "/" + IP;
    }

    /**
     * 获取$ShrineExecutors/executors/xx/noTraffic结点完整路径
     *
     * @return true 已经被摘流量；false，otherwise；
     */
    public static String getExecutorNoTrafficNodePath(String executor) {
        return "/" + Shrine_EXECUTORS_NODE + "/" + EXECUTORS + "/" + executor + "/" + NO_TRAFFIC;
    }

    /**
     * 获取$ShrineExecutors/executors/xx/clean结点完整路径
     */
    public static String getExecutorCleanNodePath(String executor) {
        return "/" + Shrine_EXECUTORS_NODE + "/" + EXECUTORS + "/" + executor + "/" + CLEAN;
    }

    /**
     * 获取$ShrineExecutors/executors/xx/task结点完整路径
     */
    public static String getExecutorTaskNodePath(String executor) {
        return "/" + Shrine_EXECUTORS_NODE + "/" + EXECUTORS + "/" + executor + "/" + TASK;
    }
    ...
    /**
     * 获取$ShrineExecutors/sharding结点完整路径
     */
    public static String getExecutorShardingNodePath(String nodeName) {
        return "/" + Shrine_EXECUTORS_NODE + "/" + SHARDING + "/" + nodeName;
    }

    /**
     * 获取$ShrineExecutors/sharding/content结点完整路径
     */
    public static String getShardingContentElementNodePath(String element) {
        return "/" + Shrine_EXECUTORS_NODE + "/" + SHARDING + "/" + CONTENT + "/" + element;
    }
