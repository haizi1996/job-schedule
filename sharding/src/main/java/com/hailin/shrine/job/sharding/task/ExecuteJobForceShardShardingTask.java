...
/**
 * 作业重排
 * 移除所有executor的该作业shard，重新获取该作业的shards，finally删除forceShard结点
 */
public class ExecuteJobForceShardShardingTask extends AbstractAsyncShardingTask {
    ...
    private void deleteForceShardNode() {
        try {
            String jobConfigForceShardNodePath = ShrineExecutorsNode.getJobConfigForceShardNodePath(jobName);
