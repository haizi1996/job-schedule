 ...
 * @author zhanghailin
 */
public class ShrineExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(ShrineExecutorService.class);
    ...
    private ShrineExecutorExtension shrineExecutorExtension;
    ...
    public ShrineExecutorService(String executorName, CoordinatorRegistryCenter coordinatorRegistryCenter, ShrineExecutorService shrineExecutorService) {
    ...
    private void registerExecutor0() throws Exception{
        ...
        executorConfigService = new ExecutorConfigService(executorName,
                ...
                shrineExecutorExtension.getExecutorConfigClass());
