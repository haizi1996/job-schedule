...
public interface ElasticJobListener {
     ...
     */
    void beforeJobExecuted(final JobExecutionMultipleShardingContext shardingContexts);
     ...
     * @param shardingContexts 分片上下文
     */
    void afterJobExecuted(final JobExecutionMultipleShardingContext shardingContexts);
}
