...
public class JobConfigurationContext implements JobRootConfiguration {
    ...
    public static class Builder {
         ...
         * @return 作业配置对象
         */
        public final JobConfigurationContext build() {
            return new JobConfigurationContext(jobConfig, monitorExecution, maxTimeDiffSeconds, monitorPort, jobShardingStrategyClass, reconcileIntervalMinutes, disabled, overwrite);
        }
    }
}
