...
public class RestartAndDumpService {
    ...
    private void initDump() throws Exception {
        dumpES = Executors.newSingleThreadExecutor(new ShrineThreadFactory(executorName + "-dump-watcher-thread", false));
    ...
    private void initRestart() throws Exception{
        restartES = Executors.newSingleThreadExecutor(new ShrineThreadFactory(executorName +
