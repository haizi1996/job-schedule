 ...
 * @author zhanghailin
 */
public class ProcessCountStatistics  {

    private static ConcurrentHashMap<String , AtomicInteger> successCountMap = new ConcurrentHashMap<>();

    private static ConcurrentHashMap<String , AtomicInteger> failureCountMap =new ConcurrentHashMap<>();

    private static ConcurrentHashMap<String , AtomicInteger> totalCountDeltaMap =new ConcurrentHashMap<>();

    private static ConcurrentHashMap<String , AtomicInteger> errorCountDeltaMap =new ConcurrentHashMap<>();
